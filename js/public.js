...
*/ (function () {
    ...
    */
    ...
    let testUrl = new URLSearchParams(location.search).get("test");
        ...
        switch (type) {
            ...
            case "localhost":
                $layer
                    .find(".contents")
                    .append(
                        '<video class="video" controls="controls" draggable="true"><source src="" type="video/mp4">해당 브라우저는 이 비디오를 재생할 수 없습니다.<br>크롬 브라우저를 권장합니다.</video>'
                    );
                ...
                $layer
                    ...
                    .append(
                        '<iframe class="youtube" src="' +
                            src +
                            '?autoplay=1&vq=hd1080&rel=0&playsinline=1" frameborder="0" allow="playsinline; accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
                    );
                break;
        }
    }
